...
internal struct DPDConstant {
	...
	internal struct UI {
		...
		static let BackgroundColor = UIColor(white:1, alpha: 1)//UIColor(white: 0.94, alpha: 1)
		static let SelectionBackgroundColor = UIColor(white:1, alpha: 1)//UIColor(white: 0.89, alpha: 1)
