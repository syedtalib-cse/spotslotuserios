...
open class WaveTabBarController: UITabBarController, WaveTabBarProtocol {
    ...
    private struct Constants {
        ...
        static let whiteBackgroundColor = #colorLiteral(red: 0.09411764706, green: 0.7254901961, blue: 0.7803921569, alpha: 1)//UIColor(red: 1.0, green: 1.0, blue: 1.0, alpha: 0.9)
    ...
    func setupTabBarColoring() {
        ...
        circle?.backgroundColor = #colorLiteral(red: 0.1215686275, green: 0.1764705882, blue: 0.1647058824, alpha: 1) //backgroundColor
    }
